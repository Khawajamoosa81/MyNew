...
@Component({
  selector: 'smart-gender-deptt-wise',
  templateUrl: './gender-deptt-wise.component.html',
  styleUrls: ['./gender-deptt-wise.component.css']
})
export class GenderDepttWiseComponent implements OnInit {
