...
@Component({
  selector: 'smart-bonus-summary-bonus-reports',
  templateUrl: './bonus-summary-bonus-reports.component.html',
  styleUrls: ['./bonus-summary-bonus-reports.component.css']
})
export class BonusSummaryBonusReportsComponent implements OnInit {
  ...
  columns: TableData[] = [
    ...
    { title: 'Bonus Due Amount', value: '' },
    { title: 'Due Amount', value: '' },
    { title: 'Distributed Amt', value: '' },
