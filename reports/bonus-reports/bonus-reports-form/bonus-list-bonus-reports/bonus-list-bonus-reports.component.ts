...
@Component({
  selector: 'smart-bonus-list-bonus-reports',
  templateUrl: './bonus-list-bonus-reports.component.html',
  styleUrls: ['./bonus-list-bonus-reports.component.css']
})
export class BonusListBonusReportsComponent implements OnInit {
  ...
  columns: TableData[] = [
    ...
    { title: 'No Of Days', value: '' },
    { title: 'Due Amount', value: '' },
    { title: 'Deduction As PAdv.', value: '' },
    { title: 'Rounded Amount', value: '' },
    { title: "Employee's Sign", value: '' },
