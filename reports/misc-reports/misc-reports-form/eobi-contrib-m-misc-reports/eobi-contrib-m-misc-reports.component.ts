...
@Component({
  selector: 'smart-eobi-contrib-m-misc-reports',
  templateUrl: './eobi-contrib-m-misc-reports.component.html',
  styleUrls: ['./eobi-contrib-m-misc-reports.component.css']
})
export class EobiContribMMiscReportsComponent implements OnInit {
