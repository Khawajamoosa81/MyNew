...
@Component({
  selector: 'smart-in-active-pessi-list-misc-reports',
  templateUrl: './in-active-pessi-list-misc-reports.component.html',
  styleUrls: ['./in-active-pessi-list-misc-reports.component.css']
})
export class InActivePessiListMiscReportsComponent implements OnInit {
