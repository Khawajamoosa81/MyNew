...
@Component({
  selector: 'smart-meal-allow-allow-and-ded',
  templateUrl: './meal-allow-allow-and-ded.component.html',
  styleUrls: ['./meal-allow-allow-and-ded.component.css']
})
export class MealAllowAllowAndDedComponent implements OnInit {
