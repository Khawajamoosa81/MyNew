...
@Component({
  selector: 'smart-rent-deduction-allow-and-ded',
  templateUrl: './rent-deduction-allow-and-ded.component.html',
  styleUrls: ['./rent-deduction-allow-and-ded.component.css']
})
export class RentDeductionAllowAndDedComponent implements OnInit {
