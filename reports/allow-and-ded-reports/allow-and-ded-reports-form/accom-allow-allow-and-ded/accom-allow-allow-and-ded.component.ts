...
@Component({
  selector: 'smart-accom-allow-allow-and-ded',
  templateUrl: './accom-allow-allow-and-ded.component.html',
  styleUrls: ['./accom-allow-allow-and-ded.component.css']
})
export class AccomAllowAllowAndDedComponent implements OnInit {
