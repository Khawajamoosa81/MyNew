...
@Component({
  selector: 'smart-travel-allow-allow-and-ded',
  templateUrl: './travel-allow-allow-and-ded.component.html',
  styleUrls: ['./travel-allow-allow-and-ded.component.css']
})
export class TravelAllowAllowAndDedComponent implements OnInit {
