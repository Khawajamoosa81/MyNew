...
@Component({
  selector: 'smart-special-allow-allow-and-ded',
  templateUrl: './special-allow-allow-and-ded.component.html',
  styleUrls: ['./special-allow-allow-and-ded.component.css']
})
export class SpecialAllowAllowAndDedComponent implements OnInit {
