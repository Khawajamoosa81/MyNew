...
@Component({
  selector: 'smart-canteen-deduction-allow-and-ded',
  templateUrl: './canteen-deduction-allow-and-ded.component.html',
  styleUrls: ['./canteen-deduction-allow-and-ded.component.css']
})
export class CanteenDeductionAllowAndDedComponent implements OnInit {
