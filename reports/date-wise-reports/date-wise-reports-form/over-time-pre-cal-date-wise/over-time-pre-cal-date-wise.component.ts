...
@Component({
  selector: 'smart-over-time-pre-cal-date-wise',
  templateUrl: './over-time-pre-cal-date-wise.component.html',
  styleUrls: ['./over-time-pre-cal-date-wise.component.css']
})
export class OverTimePreCalDateWiseComponent implements OnInit {
  ...
  columns: TableData[] = [
    ...
    { title: 'Normal OT Hr', value: '' },
    { title: 'Normal OT Amt', value: '' },
    { title: 'Extra OT Hr', value: ''},
    { title: 'Extra OT Amt', value: ''},
    { title: 'Special OT Hr', value: ''},
    { title: 'Special OT Amt', value: ''},
