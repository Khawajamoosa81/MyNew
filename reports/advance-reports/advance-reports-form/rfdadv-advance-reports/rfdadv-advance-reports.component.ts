...
@Component({
  selector: 'smart-rfdadv-advance-reports',
  templateUrl: './rfdadv-advance-reports.component.html',
  styleUrls: ['./rfdadv-advance-reports.component.css']
})
export class RFDAdvAdvanceReportsComponent implements OnInit {
