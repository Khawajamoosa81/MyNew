...
@Component({
  selector: 'smart-padv-emp-with-zero-ded-advance-reports',
  templateUrl: './padv-emp-with-zero-ded-advance-reports.component.html',
  styleUrls: ['./padv-emp-with-zero-ded-advance-reports.component.css']
})
export class PAdvEmpWithZeroDedAdvanceReportsComponent implements OnInit {
