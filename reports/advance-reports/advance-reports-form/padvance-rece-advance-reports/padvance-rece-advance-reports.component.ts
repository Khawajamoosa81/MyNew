...
@Component({
  selector: 'smart-padvance-rece-advance-reports',
  templateUrl: './padvance-rece-advance-reports.component.html',
  styleUrls: ['./padvance-rece-advance-reports.component.css']
})
export class PAdvanceReceAdvanceReportsComponent implements OnInit {
