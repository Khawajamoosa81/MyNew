...
@Component({
  selector: 'smart-tadv-rece-list-advance-reports',
  templateUrl: './tadv-rece-list-advance-reports.component.html',
  styleUrls: ['./tadv-rece-list-advance-reports.component.css']
})
export class TAdvReceListAdvanceReportsComponent implements OnInit {
