...
@Component({
  selector: 'smart-tadv-rece-list2-advance-reports',
  templateUrl: './tadv-rece-list2-advance-reports.component.html',
  styleUrls: ['./tadv-rece-list2-advance-reports.component.css']
})
export class TAdvReceList2AdvanceReportsComponent implements OnInit {
