...
@Component({
  selector: 'smart-ppaid-advance-advance-reports',
  templateUrl: './ppaid-advance-advance-reports.component.html',
  styleUrls: ['./ppaid-advance-advance-reports.component.css']
})
export class PPaidAdvanceAdvanceReportsComponent implements OnInit {
